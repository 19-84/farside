...
| Service | Repo (last push) | Registry | Parsing | Live | Verdict |
|---|---|---|---|---|---|
| redlib | active 2026-04 | redlib-instances JSON | OK | 1/5 | **healthy** |
| libreddit | stale 2025-02 | shares redlib registry | OK | 1/5 | superseded by redlib |
| nitter | active 2026-06 | status.d420.de (now a list) | OK¹ | 2/6 | **healthy** |
| rimgo | active 2026-06 | rimgo.codeberg.page JSON | OK | 6/21 | **healthy** |
| breezewiki | active 2026-06 | docs.breezewiki.com JSON | OK | 5/16 | **healthy** |
| gothub | active 2026-06 | codeberg JSON | OK | 5/6 | **healthy** |
| librey | active 2026-06 | LibreY JSON | OK | 3/14 | **healthy** |
| tent | active 2026-04 | forgejo.sny.sh JSON | OK | 5/11 | **healthy** |
...
| searxng | active 2026-06 | searx.space JSON (83) | OK | 0/33 | instances behind Anubis walls |
| searx | active 2026-05 (legacy) | searx-instances yml (9) | OK | 0/9 | legacy; superseded by searxng |
| invidious | active 2026-06 | api.invidious.io JSON (8) | OK | 0/6 | instances walled/dead |
...
| quetre | active 2025-11 | README only | none | 1/16 | live, no auto-discovery |
| libremdb | active 2026-04 | README only | none | 0/13 | live ones exist, no auto-discovery |
| dumb | active 2026-04 | README only | none | 1/7 | live, no auto-discovery |
| anonymousoverflow | active 2025-12 | README only | none | 3/12 | live, no auto-discovery |
| 4get | active 2026-06 | HTML page only (no JSON) | none | 5/18 | live, no auto-discovery |
...
| proxigram | stale 2024-12 | none found | none | 0/6 | **defunct** |
| librarian | **archived** 2024-12 | none | none | 0/6 | **defunct** |
| wikiless | **repo gone (404)** | commented out | n/a | 0/10 | **defunct** |
